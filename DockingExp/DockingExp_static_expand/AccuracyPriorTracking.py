...
def control_threading(target_pos, pid_fb, pid_sd):
    ...
    PID_orient_smlangle = PID(15,0,0.5) # adjust the orientation
    ...
    while not reach:
        ...
        if distance < 0.08 and abs(angle_error) < 5: # < 5cm and < 5 degree
            reach = True
            break
...
def navigation_threading():
    ...
    # points
    pid_fb = [[8,0,5],[12.5,0,5],[8,0,5],[13,0,5],]
    pid_sd = [[8,0,5],[10,0,5],[8,0,5],[13,0,5],]
