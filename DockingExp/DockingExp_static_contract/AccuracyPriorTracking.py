...
def control_threading(target_pos, pid_fb, pid_sd):
    ...
    while not reach:
        ...
        if distance < 0.08 and abs(angle_error) < 10: # < 5cm and < 5 degree
            reach = True
            break
...
def navigation_threading():
    ...
    # points
    pid_fb = [[8,0,5],[8,0,5],[8,0,5],[10,0,5],]
    pid_sd = [[8,0,5],[8,0,5],[8,0,5],[10,0,5],]
    
    target_pos = [[-1.8, 1.8, 175],[0.78, -1, 175],[0.78, -1.773, 175],[0.78, -2.173, 175],]
